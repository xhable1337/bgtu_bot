...
wday_tuesday = [no, 'Физика', 'Биология', 'Математика', 'Рус.язык', 'Ин.язык', 'Литература', 'Физ-ра', [no, 217, 301, 219, 318, '311/223', 318, 'б/з']]
...
wday_friday = ['Ин.язык', 'Математика', 'Литература', 'Химия', 'Иссл. деят-ь', no, no, no, ['311/223', 219, 318, 309, 221, no, no, no]]
...
>>>>>>> c50a040a7065eb95ed4df94fca6663a4425b09ee
