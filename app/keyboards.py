...
kbm.row(
    types.InlineKeyboardButton(text="⚡️ Сегодня", callback_data="today"),
...
kbm.row(
    types.InlineKeyboardButton(
        text="📱 Веб-приложение", web_app=types.WebAppInfo(url="https://tgweb.darx.zip")
    )
)
...
kb_cancel.row(types.InlineKeyboardButton(text="🚫 Отмена", callback_data="tomain"))

# Меню правки ежедневных уведомлениий
kb_notifications = types.InlineKeyboardMarkup()
kb_notifications.row(
    types.InlineKeyboardButton(text="❌ Удалить", callback_data="del_notification")
)
kb_notifications.row(
    types.InlineKeyboardButton(text="✍ Изменить", callback_data="edit_notification")
)
kb_notifications.row(
...
kb_notifications_days.row(
    ...
    types.InlineKeyboardButton(text="Сб", callback_data="notify_saturday"),
...
def days_keyboard(buttons):
    ...
    kb_dn.row(
        types.InlineKeyboardButton(text=buttons[0], callback_data="week_odd"),
        types.InlineKeyboardButton(text="Пн", callback_data="wday_monday_odd"),
        types.InlineKeyboardButton(text="Вт", callback_data="wday_tuesday_odd"),
        types.InlineKeyboardButton(text="Ср", callback_data="wday_wednesday_odd"),
        types.InlineKeyboardButton(text="Чт", callback_data="wday_thursday_odd"),
        types.InlineKeyboardButton(text="Пт", callback_data="wday_friday_odd"),
        types.InlineKeyboardButton(text="Сб", callback_data="wday_saturday_odd"),
    )
    kb_dn.row(
        types.InlineKeyboardButton(text=buttons[1], callback_data="week_even"),
        types.InlineKeyboardButton(text="Пн", callback_data="wday_monday_even"),
        types.InlineKeyboardButton(text="Вт", callback_data="wday_tuesday_even"),
        types.InlineKeyboardButton(text="Ср", callback_data="wday_wednesday_even"),
        types.InlineKeyboardButton(text="Чт", callback_data="wday_thursday_even"),
        types.InlineKeyboardButton(text="Пт", callback_data="wday_friday_even"),
        types.InlineKeyboardButton(text="Сб", callback_data="wday_saturday_even"),
    )
    kb_dn.row(
        types.InlineKeyboardButton(text="🔄 В главное меню", callback_data="tomain")
    )
...
kb_admin_back.row(
    types.InlineKeyboardButton(text="🔄 В админ-меню", callback_data="toadmin")
)


kb_update_teachers = types.InlineKeyboardMarkup()
kb_update_teachers.row(
    types.InlineKeyboardButton(text="✅ Да", callback_data="update_teachers_yes")
)
