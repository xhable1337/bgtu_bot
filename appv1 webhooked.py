...
wednesday_lessons = [no, 'Литература', 'Ин.язык', 'Физика', 'Физкультура', 'Математика', 'История', no,
[no, 318, '318/223', 217, 'б/з', 219, 229, no]]
...
kbm.row(types.InlineKeyboardButton(text='Расписание звонков', callback_data='ring_menu'))
